...
def main_debug(displaying):
  ...
  while True:
    ...
    detections = detector.detectopencv(frame)
...
def detect_in_frame_lva():
  ...
  detections = detector.detectlva(img)
...
if __name__== "__main__":
  ...
  shared_manager, detector = get_detector_shared_manager(args.detector, args.device, "FP16", init_shared_mem=value)
